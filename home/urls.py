...
urlpatterns = [
    ...
    path('faculty/sysstat/classinit/selectfile/', views.roster_upload, name="roster_upload"),
    path('faculty/sysstat/classinit/send/', views.excel_upload_handler, name="excelsend"),
